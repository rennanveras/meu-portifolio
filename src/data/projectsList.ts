...
export const projectList: Project[] = [
  ...
  },
  {
    ...
    urlGithub: 'https://github.com/rennanveras/efood',
    urlProjeto: 'https://efood-gamma-three.vercel.app',
    title: 'Efood ',
  ...
  },
  {
    ...
    desc: 'gestor de tarefas oferece filtragem por importância, uma barra de pesquisa poderosa e organização intuitiva. Adicione, encontre e priorize suas tarefas com facilidade. Totalmente responsivo, otimize sua produtividade em todos os dispositivos. Experimente agora e simplifique sua rotina diária!',
    tech: 'ReactJs - Styled-components - Typescript - Redux'
  },
  {
    id: 5,
    thumbnail: 'thumbnail-github.webp',
    urlGithub: 'https://github.com/rennanveras/search_github',
    urlProjeto: 'https://search-github-lyart.vercel.app',
    title: 'Busque um perfil no github',
    desc: 'Este projeto é uma aplicação web que permite aos usuários pesquisar por um perfil do GitHub. Ao inserir o nome do perfil desejado, a aplicação consulta a API do GitHub e exibe informações relevantes sobre o usuário, incluindo sua foto de perfil, nome e uma lista de seus repositórios. Os usuários podem facilmente visualizar os projetos associados ao perfil pesquisado, proporcionando uma maneira rápida e conveniente de explorar o trabalho de outros desenvolvedore.',
  ...
  },
  {
    ...
    desc: 'Descubra as últimas inovações e tendências no nosso evento de tecnologia. Contagem regressiva em andamento - participe para explorar novas tecnologias, fazer networking e participar de workshops interativos. Registre-se agora para garantir seu lugar no futuro da tecnologia!',
